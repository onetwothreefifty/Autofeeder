...
namespace JungleStack
{
    class Program
    {
        ...
        {
            new Vector3(4961,4434,262),  // Wait for attack
            new Vector3(4961,4434,262), // Move for pulling
            new Vector3(4961,4434,262) // Wait position
        };

        private static readonly Vector3[] StackRouteDire =
        {
            new Vector3(-5390,-4926,264),  // Wait for attack
            new Vector3(-5390,-4926,264), // Move for pulling
            new Vector3(-5390,-4926,264) // Wait position
        };
